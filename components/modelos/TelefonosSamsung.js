...
class Postsams extends Component {
...
handlePC(item) {
  ...
  if(item.titulo =="Botones"){
    ...
    const as = `/reparacion/${modelo}/Parlante-Superior`;
    Router.push(`/reparacion/[modelo]/[repuesto]`,as)
  }
  else if(item.titulo =="Altavoz"){
  
    const as = `/reparacion/${modelo}/Altavoz`;
    Router.push(`/reparacion/[modelo]/[repuesto]`,as)
  }
  else if(item.titulo =="Lente de cámara"){
  
    const as = `/reparacion/${modelo}/Lente-de-Camara`;
    Router.push(`/reparacion/[modelo]/[repuesto]`,as)
  }
    ...
    const as = `/reparacion/${modelo}/Tapa`;
    Router.push(`/reparacion/[modelo]/[repuesto]`,as)
  }
  else if(item.titulo =="Vibrador"){

    const as = `/reparacion/${modelo}/Vibrador`;
    Router.push(`/reparacion/[modelo]/[repuesto]`,as)
  }
...
export default withRouter(Postsams) 